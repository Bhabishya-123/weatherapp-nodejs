...
app.get('/',(req,res)=>{
    ...
    requests('http://api.openweathermap.org/data/2.5/weather?q=kathmandu&appid=344b134b52cf63f9d28bb5e7ea69259b&units=metric')
...
app.post('/', urlencodedParser, function (req, res) {
  ...
  requests('http://api.openweathermap.org/data/2.5/weather?q='+reqCity+'&appid=344b134b52cf63f9d28bb5e7ea69259b&units=metric')
...
//this express app server listen on port 8080
app.listen(8080);
